...
event.recipes.gtceu.plasma_generator('starmatterliquified')
    .inputFluids(Fluid.of('gtceu:condensed_star_matter', 500))
    .duration(2560)
...
event.recipes.gtceu.dimensionalmatter('matter')
    ...
    .duration(40)
    .EUt(GTValues.VA[GTValues.UEV]);
event.recipes.gtceu.dimensionalmatter('venus_rp')
    .notConsumable('kubejs:gravitational_containment_cell')
    .itemInputs('kubejs:quantum_energy_capsule')
    .circuit(24)
    .biome('ad_astra:venus_wastelands')
    .itemOutputsRanged( 'kubejs:exotic_matter', 10, 15)
    .outputFluids(Fluid.of('gtceu:acidic_venus_residue 1000'))
    .duration(40)
    .EUt(GTValues.VA[GTValues.UEV]);
