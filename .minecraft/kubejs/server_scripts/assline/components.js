...
event.recipes.gtceu.assembly_line('uhvmotor')
...
event.recipes.gtceu.assembly_line('uhvpump')
...
.duration(600)
.EUt(GTValues.VA[GTValues.UV])
event.recipes.gtceu.assembler('fluidregulatoruhv')
.itemInputs('gtceu:uhv_electric_pump', '2x gtceu:wetware_processor_mainframe')
.circuit(1)
.itemOutputs('gtceu:uhv_fluid_regulator')
.duration(50)
.EUt(GTValues.VA[GTValues.UV])
event.recipes.gtceu.assembly_line('uhvconveyor')
...
.duration(600)
.EUt(GTValues.VA[GTValues.UV])
event.recipes.gtceu.assembly_line('uhvpiston')
...
.duration(600)
.EUt(GTValues.VA[GTValues.UV])
event.recipes.gtceu.assembly_line('uhvarm')
...
.duration(600)
.EUt(GTValues.VA[GTValues.UV])
event.recipes.gtceu.assembly_line('uhvenergyhatch')
...
event.recipes.gtceu.assembly_line('uhvenergydyanmohatch')
